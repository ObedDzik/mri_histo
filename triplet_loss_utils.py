...
def get_histo_by_isup(encodings_dir, marksheet_csv, num_classes = 6, provider = 'karolinska'):
...
def get_triplet_samples(mri_gt_label, histo_dict, num_classes=6): 
...
def triplet_loss(mri_emb, mri_gt_label, histo_dict, margin=1, reduction: str = "mean", num_classes=6):
